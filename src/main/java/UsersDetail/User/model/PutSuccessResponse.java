...
public class PutSuccessResponse   {
  ...
  public PutSuccessResponse error(Error error) {
    this.error = error;
    return this;
  }
  ...
  */
  ...
  public PutSuccessResponse request(Request request) {
  ...
  */
  ...
  public PutSuccessResponse data(GetErrorResponseAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PutSuccessResponse putSuccessResponse = (PutSuccessResponse) o;
    return Objects.equals(this.error, putSuccessResponse.error) &&
        Objects.equals(this.request, putSuccessResponse.request) &&
        Objects.equals(this.data, putSuccessResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutSuccessResponse {\n");
